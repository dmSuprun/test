...
urlpatterns = [
    ...
    path('show_tests_and_materials/', show_all_tests, name='show_all_tests'),
    ...
    path('material/', create_materials, name='create_material'),
    path('update/material/<str:uuid_material>', update_material, name='update_material'),
